...
const desktopVideos = [
    'frame 1.mp4', // Desktop Part 1
    'frame 2.mp4',  // Desktop Part 2
    'frame 3.mp4', // Desktop Part 3
    'frame 4.mp4'  // Desktop Part 4
];

const mobileTabletVideos = [
    'cracking egg 1-1.mp4', // Mobile/Tablet Part 1 (PLACEHOLDER - REPLACE WITH YOUR ACTUAL MOBILE VIDEO PATHS)
    '1-2.mp4', // Mobile/Tablet Part 2
    'cracking egg 1-3.mp4', // Mobile/Tablet Part 3
    'cracking egg 1-4.mp4'  // Mobile/Tablet Part 4
];
